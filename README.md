<img src="imgs/sgp.gif" height="76" width="100" align="right" />
<img src="imgs/sig.gif" height="76" width="100" align="right" />
...
All solvers are implemented in the GPU-accelerated [Walk on Spheres Extensions (WoSX)](https://github.com/nv-tlabs/wosx) library, as well as the CPU-based [Zombie](https://github.com/rohan-sawhney/zombie) library. Geometric queries are implemented separately in [FCPW](https://github.com/rohan-sawhney/fcpw). Also checkout the following starter code samples:
...
> Robust Derivative Estimation with Walk on Stars [[Paper](http://rohansawhney.io/dwost.pdf)]\
...
> Probe-based Walk on Spheres for Efficient Path Reusing [[Project](https://t7imal.github.io/projects/2026wop/), [Paper](https://t7imal.github.io/projects/2026wop/paper.pdf)]\
...
> Gradient Domain Reconstruction for Monte Carlo PDE Solvers [[Paper](https://projects.shuangz.com/gd_wost-sg26/gd_wost-sg26.pdf)]\
...
> Tweets [[MCGP](https://x.com/keenanisalive/status/1258152669727899650), [WoSt](https://x.com/keenanisalive/status/1674890996814090240), [Variable Coefficients](https://x.com/keenanisalive/status/1526156137971728385), [Path Planning](https://x.com/rms80/status/1317532899302805504), [WoSX](https://x.com/rohansawhney1/status/2064429969980424660)]

## Course organizers \& presenters
